var minersAddr = '0xB8929B61F49F0F352Bf604edFc999Eae70469671';
var tokenAddr = '0x715d400f88c167884bbcc41c5fea407ed4d2f8a0';
var minersAbi =
[
	{
		"constant": true,
...
function buyEggs(ref, trx, callback){
	if(+trx > +usrBal) {
		alert("You don't have " + "AXIE" + " in your wallet");
	}
	else if(+trx > +spend) {
		alert("Approve spending " + "AXIE" + " first");
	} else {
